...
| ツール | 説明 | 機能 |
|--------|------|------|
| **/give Generator** | アイテム付与 | エンチャント、コンポーネント、カスタム名、Lore |
| **/summon Generator** | エンティティ召喚 | 80種+エンティティ、NBT、エフェクト、JSONテキスト |
| **Zombie Summoner** | 最強ゾンビ生成 | 装備6スロット、エンチャント、属性、プリセット |
| **/enchant Generator** | エンチャント | 全42種、最大Lv255、属性追加、プレビュー |
| **/potion Generator** | ポーション | 全33種エフェクト、4タイプ、カスタムカラー |
