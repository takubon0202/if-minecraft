...
style.textContent = `
  ...
  @media (max-width: 600px) {
    ...
    .summon-zombie-tool .equipment-grid-armor,
    .summon-zombie-tool .equipment-grid-hands {
      grid-template-columns: repeat(2, 1fr);
    }

    .summon-zombie-tool .slot-bottom-row {
      flex-direction: column;
    }

    .summon-zombie-tool .equipment-slot {
      padding: 12px;
    }

    .summon-zombie-tool .slot-icon-large {
      width: 48px;
      height: 48px;
    }

    .summon-zombie-tool .slot-icon-large img {
      width: 36px;
      height: 36px;
    }
  }
